...
apply(mpg[, c('displ', 'cyl', 'cty', 'hwy')], 1, mean) # riga
apply(mpg[, c('displ', 'cyl', 'cty', 'hwy')], 2, mean) # colonna
...
temp <- list.files(path = '/Users/valentinaporcu/Desktop/toimp', pattern = 'csv',
                   full.names = TRUE)
